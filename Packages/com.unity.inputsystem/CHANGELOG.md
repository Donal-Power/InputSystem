...
- Fixed Irrelevant errors thrown in editor when Project-wide Input Actions contains custom InputProcessor [ISXB-858](https://issuetracker.unity3d.com/product/unity/issues/guid/ISXB-858)
